...
// Parses 370 questions from document.md at runtime
...
const QUESTIONS = [
  ...
  },
  {
    "id": 20,
    "category": "AI Agents",
    "question": "Universal Containers (UC) wants to offer personalized service experiences and reduce agent handling time with AI-generated email responses, grounded in Knowledge base. Which AI capability should UC use?",
    "choices": [
  ...
  },
  {
    ...
    "choices": [
      "AI-generated synthetic test utterances based on natural language variations",
    ...
    "correctAnswerText": "AI-generated synthetic test utterances based on natural language variations",
  ...
  },
  {
    "id": 51,
    "category": "Prompt Engineering",
    "question": "Universal Containers (UC) needs to create a prompt template that provides a detailed product description based on the latest product data. The description will be used in marketing materials to ensure consistency and accuracy. Which prompt template type should UC use?",
    "choices": [
      "Record Summary",
      "Sales Email",
      "Field Generation"
  ...
  },
  {
    ...
    "choices": [
      ...
      "Only before\\_reasoning can guarantee the large language model (LLM) is invoked before an action runs.",
  ...
  },
  {
    ...
    "choices": [
      "Role: You are an experienced support agent. Task: Summarize the case notes, Context: Include customer issue, troubleshooting steps, and next actions. Constraints: Limit to 5 sentences, use plain language, and if no next action is found, state \"No next action required.\" Format: Use numbered sentences for clarity.",
  ...
  },
  {
    ...
    "choices": [
      ...
      "The Agentforce Specialist can use most utilities directly, but @utils.escape requires a custom Apex class to define the escalation queue.",
  ...
  },
  {
    "id": 116,
    "category": "AI Agents",
    "question": "Universal Containers is developing an Agentforce Service Agent to handle a complex, multi-step customer onboarding process. To better organize the conversational logic, the Agentforce Specialist splits the process across two distinct subagents and places the setup configuration for the second step inside the before\\_reasoning block of the new subagent. During testing, when the agent transitions to this new subagent mid-conversation, the conversation occasionally stalls or behaves unexpectedly. What is the risk the Agentforce Specialist must consider regarding the execution timing of before\\_reasoning?",
    "choices": [
  ...
  },
  {
    "id": 147,
    "category": "AI Agents",
    "question": "Universal Containers wants to be able to detect with a high level confidence if content generated by a large language model (LLM) contains toxic language. Which action should an AI Specialist take in the Trust Layer to confirm toxicity is being appropriately managed?",
    "choices": [
  ...
  },
  {
    ...
    "choices": [
      ...
      "Export agent components as JSON files and manually import them into production using the Metadata API.",
  ...
  },
  {
    "id": 202,
    "category": "AI Agents",
    "question": "A business stakeholder wants to use AI to generate a summary based on Data Cloud data. Which method(s) should the stakeholder use to access Data Cloud data from Prompt Builder?",
    "choices": [
  ...
  },
  {
    "id": 206,
    "category": "AI Agents",
    "question": "An Agentforce at Universal Containers is working on a prompt template to generate personalized emails for product demonstration requests from customers. It is important for the AI- generated email to adhere strictly to the guidelines, using only associated opportunity information, and to encourage the recipient to take the desired action. How should the Agentforce Specialist include these instructions on a new line in the prompt template?",
    "choices": [
  ...
  },
  {
    "id": 209,
    "category": "AI Agents",
    "question": "Universal Containers wants to use an existing prompt template inside Flow as part of automation. What can be used?",
    "choices": [
      "Invocable Apex",
      "Einstein for Flow",
      "Flow action"
  ...
  },
  {
    ...
    "correctAnswerText": "Create concise, clear, and consistent prompt templates with effective grounding, contextual role-playing, clear instructions, and iterative feedback.",
  ...
  },
  {
    ...
    "choices": [
      ...
      "Using a dialog pattern, the LLM matches the user query to the available topic, action and steps then performs the steps for each action, such as retrieving a fast of open opportunities."
    ],
  ...
  },
  {
    ...
    "choices": [
      "The flow must have the \"with sharing\" permission selected in the advanced settings for the permissions, field-level security, and sharing settings to be respected.",
  ...
  },
  {
    "id": 247,
    "category": "AI Agents",
    "question": "A company wants to retrieve patient history details to augment the AI agent response. [he company wants to leverage the Data Cloud search index feature. What is best practice when considering retrieval-augmented generation (RAG) for information that may contain personally identifiable information (PII)?",
    "choices": [
  ...
  },
  {
    "id": 251,
    "category": "AI Agents",
    "question": "Universal Containers (UC) configured a new PDF file ingestion in Data Cloud with all the required fields, and also created the mapping and the search Index. UC Is now setting up the retriever and notices a required field is missing. How should UC resolve this?",
    "choices": [
  ...
  },
  {
    ...
    "correctAnswerText": "Data preparation Involves loading, chunking, vectorizing, and storing content in a search-optimized manner to support retrieval from the vector database.",
  ...
  },
  {
    ...
    "correctAnswerText": "Create a custom retriever in Einstein Studio, and apply filters for publication date and product line.",
  ...
  },
  {
    "id": 275,
    "category": "AI Agents",
    "question": "Universal Containers needs to create Data Cloud reports to understand agent behavior. Which data lake object (DLO) represents an overarching container capturing contiguous interactions with one or more AI agents?",
    "choices": [
      "AlAgentInteraction",
  ...
  },
  {
    ...
    "choices": [
      "Use the keyword run within the create\\_account action to chain the send\\_verification action as a follow-up.",
      "Add the send\\_verification logic inside the procedural instructions so it executes before profile setup finishes.",
      "Configure the send\\_verification action to be available when account\\_created = True and wait for the agent to call it in the next step."
    ],
    "correctAnswerText": "Add the send\\_verification logic inside the procedural instructions so it executes before profile setup finishes.",
    "explanation": "The correct answer is B because the requirement is immediate, deterministic sequencing after account creation. Procedural instructions in Agent Script are designed for multi-step workflows where the agent must run actions in a required order without waiting for another user turn. The specialist should structure the workflow so that after account creation succeeds, the procedural logic runs the verification email step before advancing to profile setup. Option A is phrased incorrectly because run belongs in Agent Script procedural instructions, not inside the create_account action itself. Option C is weaker because making an action available does not force immediate execution. Salesforce Agent Script recipes describe action chaining with run, step tracking, procedural instructions, and automatic follow-up action execution in multi-step workflows."
  },
  {
    "id": 284,
    "category": "Data 360 Fundamentals",
  ...
  },
  {
    "id": 301,
    "category": "AI Agents",
    "question": "Which configuration must An Agentforce complete for users to access generative AI-enabled fields in the Salesforce mobile app?",
    "choices": [
      "Enable Mobile Generative AI.",
      "Enable Mobile Prompt Responses.",
      "Enable Dynamic Forms on Mobile."
    ],
    "correctAnswerText": "Enable Mobile Generative AI.",
  ...
  },
  {
    ...
    "choices": [
      "Enable Agentforce Health Monitoring to configure escalation rate alert thresholds and export the resulting trend data into a Tableau dashboard aligned with the VP of Service's reporting requirement s",
  ...
  },
  {
    ...
    "choices": [
      "Populate an AI-generated time-to close estimation to opportunities",
      "Populate an AI generated summary field for sales contracts.",
      "Populate an AI generated lead score for new leads."
    ],
  ...
  },
  {
    "id": 315,
    "category": "AI Agents",
    "question": "Universal Containers Is Interested In Improving the sales operation efficiency by analyzing their data using AI-powered predictions in Einstein Studio. Which use case works for this scenario?",
    "choices": [
  ...
  },
  {
    ...
    "choices": [
      "lightning\\_\\_stringType",
      "apex\\_\\_String",
      "lightning\\_\\_textType"
    ],
    "correctAnswerText": "lightning\\_\\_stringType",
  ...
  },
  {
    ...
    "choices": [
      ...
      "From the Epstein setup menu, select Turn on Einstein: create custom fields to store Issue, Resolution, and Summary: create a Quick Action that updates these fields: and add the wrap up component to the Messaging session record page layout.",
  ...
  },
  {
    ...
    "choices": [
      "Add an available when: @variables.is\\_verified == true condition to the order details subagent.",
      "Declare the is\\_verified variable as immutable so it cannot be modified during the session.",
      "Update the is\\_verified variable to true after the verification action succeeds using @utils.setVariables."
    ],
    "correctAnswerText": "Update the is\\_verified variable to true after the verification action succeeds using @utils.setVariables.",
  ...
  },
  {
    ...
    "choices": [
      ...
      "Build AI model with Einstein discovery and deploy to sales users.",
...
function renderAllQuizTabs() {
  ...
  renderQuizTab(7, "Full 370-Question Simulator", [...state.questions]);
}
